...
<div className="px-4 w-full max-w-[1400px] mx-auto py-4 items-center justify-center">
  <div className="pt-[650px] sm300:pt-[710px] sm400:pt-[520px] ipad-mini:pt-[10px] sm:pt-[200px] md:pt-[100px] lg:pt-[50px] mt-[60px] sm:mt-[40px] md:mt-[20px] lg:mt-[10px] custom-1024:mt-[20px]">
    <p className="text-gray-400  text-sm sm:text-base md:text-lg lg:text-xl leading-6 pb-12 text-center">
      ...
      first-rate support ensures that the system is consistently functional and always receiving new improvements and features.
    </p>
  </div>

  {sections.map((section) => (
    <div key={section.id} className="w-full">
      <div className="flex justify-between items-center p-4 bg-black rounded-lg shadow-md mb-4">
        ...
        {expandedSections[section.id] && (
          <div className="bg-white p-4 rounded-lg shadow-md">
            {section.content.map((text, index) => (
              <p key={index} className="text-black mb-4 text-sm sm:text-base">
                {text}
              </p>
            ))}
          </div>
